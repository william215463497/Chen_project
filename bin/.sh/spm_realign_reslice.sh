#!/bin/bash
#
# Setup (with option to run) SPM25 realign and reslice EPI module using 
...
matlab -nosplash -nodesktop > matlab.out << EOF
  ...
  matlabbatch{1,1}.spm.spatial.realign.estwrite.eoptions.quality = 0.95;
  matlabbatch{1,1}.spm.spatial.realign.estwrite.eoptions.sep = 1.5;
