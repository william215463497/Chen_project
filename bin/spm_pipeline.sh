...
DERIVATIVES_DIR=${PROJECT_DIR}/data/derivatives/func_conn
SEL_DATA_ARR=("o02")
...
STUDY_SPECIFIC_OTHER_CLEANUP_SCRIPT=${PROJECT_DIR}/code/pipelines/spm_pipeline_other_cleanup.sh
...
STUDY_SPECIFIC_MAKE_LVL1_CON_LIST_SCRIPT=${PROJECT_DIR}/code/pipelines/spm_make_lvl1_con_lists.sh # Be sure to check this file
STUDY_SPECIFIC_MAKE_LVL2_SPEC_LIST_SCRIPT=${PROJECT_DIR}/code/pipelines/bash_make_spm_lvl2_spec_lists.sh # Be sure to check this file
STUDY_SPECIFIC_MAKE_LVL2_CON_LIST_SCRIPT=${PROJECT_DIR}/code/pipelines/bash_make_spm_lvl2_con_lists.sh # Be sure to check this file
GROUP_NAME=group
